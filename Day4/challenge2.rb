...
#greetings, please enter pin, choose withdraw or check balance,
#if withdraw ask if he needs to show his balance,
#ask if he wants to print his transaction, thank you bye bye
